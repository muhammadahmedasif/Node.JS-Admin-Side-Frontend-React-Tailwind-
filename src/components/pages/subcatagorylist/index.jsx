...
const columns = [
    { id: "subcatagoryimage", label: "Subcategory Image", minWidth: 200, align: "center" },
    { id: "subcatagory", label: "Subcategory", minWidth: 100, align: "center" },
        ...
        <>
            <section className="w-full h-full">
                ...
                <div className="my-6 h-[600px] w-full bg-white border border-gray-300 flex-col flex items-start">
                    ...
                    <TableHeaderReeusableComponent title={'Sub Catagory'} model={'Add Catagory'} button={'Add Sub Catagory'}/>
                    {/* Scrollable Table */}
                    <div
                        id="products-scroll"
