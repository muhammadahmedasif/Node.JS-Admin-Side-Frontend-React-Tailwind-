                ...
                <form action="" className="mt-10 py-5 flex flex-col gap-4 w-full">
                    ...
                    <div className="flex items-center justify-between mt-7">
                        <div className="w-full flex items-center">
                            <input type="checkbox" id="checkbox" className="w-6 h-6 accent-blue-600 hover:ring-2 hover:ring-gray-300 
                                hover:ring-offset-2 hover:ring-offset-white cursor-pointer"/>
                            <label htmlFor="checkbox" className="pl-1 font-[600] text-[14px] text-gray-600"> By signing up you have agreed to our <span className="text-black font-[600]">Terms</span> & <span className="text-black font-[600]">Privacy Policy</span></label>
                        </div>
                    </div>
